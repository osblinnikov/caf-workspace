...
def add_dependencies(env, args):
    ...
    AddDependency(args,'com_github_actor_framework_libcaf_opencl',join(args['PROJECTS_ROOT_PATH'],'src/github.com/actor-framework/libcaf_opencl'))
...
def add_unit_test(testName, additionalFiles=[]):
    args['PROG_NAME'] = 'com_github_actor_framework_unit_testing_'+testName
